...
function(slickdist) {
    ...
    slickCarousel.showPlayer = function() {
        jQuery(".slick-active.video-slide img.overlay-image").show();
        jQuery(".slick-active.video-slide .carousel-image-wrapper").css("opacity", 1);
        jQuery(".video-play-btn").css("opacity", 1);
        jQuery(".video-play-btn").css("pointer-events", "none");
        jQuery(".video-play-btn").show();
    };

    slickCarousel.hidePlayer = function() {
        jQuery(".slick-active.video-slide img.overlay-image").hide();
        jQuery(".slick-active.video-slide .carousel-image-wrapper").css("opacity", 0);
